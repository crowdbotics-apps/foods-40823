"""
Django settings for foods_40823 project.
...
WSGI_APPLICATION = 'foods_40823.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "foods_40823 API",
    "DESCRIPTION": "API documentation for foods_40823 App",
    "VERSION": "v1",
}
